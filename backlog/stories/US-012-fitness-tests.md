...
- [ ] Migracja SQL: tabela `fitness_test_results` z RLS
- [ ] Katalog testów: `lib/constants/fitness-tests.ts` z mapowaniem sport → testy
- [ ] API route: `app/api/athletes/[id]/tests/route.ts` (GET, POST)
- [ ] API route: `app/api/athletes/[id]/tests/[testId]/route.ts` (DELETE)
...
- [ ] Unit testy: trend calculation, sport filtering, form validation
