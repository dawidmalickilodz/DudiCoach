...
- Run post-implementation reviews in parallel where possible:
  - UI/UX
  - QA
  - Security
  - Performance
  - Code review
- Consolidate verdicts into one final decision.
- If subagents/tools are unavailable, proceed with safest fallback and clearly state limits.
